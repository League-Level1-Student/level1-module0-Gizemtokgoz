...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess3.equalsIgnoreCase("johnny")) {
			score += 1;
			JOptionPane.showMessageDialog(null, "Correct :) Your score is " + score);
		}
		
		else if (guess3.equalsIgnoreCase("johny")) {
			score += 1;
			JOptionPane.showMessageDialog(null, "Correct :) Your score is " + score);
		}
		...
		JOptionPane.showMessageDialog(null, "Your current score is " + score + ". GOOD JOB!");
	}
